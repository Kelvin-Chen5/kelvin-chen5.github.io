...
const UshMicroshellProject = () => {
    return (
        <>
            <div class="row">
                <div class="center col-sm-8 col-lg-5">
                    ...
                    <img class="container-fluid" src={task1} width="500px" alt="task1Img"/>
                    ...
                    <img class="container-fluid" src={task2} width="500px" alt="task2Img"/>
                    ...
                    <img class="container-fluid" src={task3} width="500px" alt="task3Img"/>
                    ...
                    <img class="container-fluid" src={task4} width="500px" alt="task4Img"/>
                </div>
            </div>
        </>
    );
